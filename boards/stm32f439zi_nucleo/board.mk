...
PLATFORM = stm32f4
TESTS ?= gpio timer flash uart spi i2c rng sha1 sha224 sha256 hmac_sha1 hmac_sha224 hmac_sha256 eth
...
CFLAGS += -Wall -Werror $(INCLUDE) -g3 -Os -ffunction-sections -fdata-sections \
 ...
 -DWHAL_CFG_STM32F4_RNG_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_SHA1_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_SHA224_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_SHA256_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_HMAC_SHA1_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_HMAC_SHA224_DIRECT_API_MAPPING \
 -DWHAL_CFG_STM32F4_HASH_HMAC_SHA256_DIRECT_API_MAPPING \
...
BOARD_SOURCE += $(wildcard $(WHAL_DIR)/src/eth_phy/lan8742a_eth_phy.c)
