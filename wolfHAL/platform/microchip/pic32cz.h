...
#define WHAL_PIC32CZ_FLASH_REGMAP       \
    .base = 0x44002000,                 \
    .size = 0x4000
#define WHAL_PIC32CZ_FLASH_DRIVER &whal_Pic32czFlash_Driver

#define WHAL_PIC32CZ_SUPPLY_REGMAP      \
    .base = 0x44020000,                 \
    .size = 0x2000
#define WHAL_PIC32CZ_SUPPLY_DRIVER &whal_Pic32czSupc_Driver

#define WHAL_PIC32CZ_CLOCK_PLL_REGMAP   \
    .base = 0x44040000,                 \
    .size = 0x14000
#define WHAL_PIC32CZ_CLOCK_PLL_DRIVER &whal_Pic32czClockPll_Driver

#define WHAL_PIC32CZ_GPIO_REGMAP        \
    .base = 0x44840000,                 \
    .size = 0x2000
#define WHAL_PIC32CZ_GPIO_DRIVER &whal_Pic32czGpio_Driver

#define WHAL_PIC32CZ_SERCOM4_UART_REGMAP    \
    .base = 0x46004000,                     \
    .size = 0x2000
#define WHAL_PIC32CZ_SERCOM4_UART_DRIVER &whal_Pic32czUart_Driver
