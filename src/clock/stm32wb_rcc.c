                                     ...
                                     whal_Stm32wb_Rcc_MsiRange range)
{
    ...
    whal_Reg_Update(clkDev->base, RCC_CR_REG, RCC_CR_MSION_Msk,
                    RCC_CR_MSION_Msk);
    do {
        whal_Reg_Get(clkDev->base, RCC_CR_REG, RCC_CR_MSIRDY_Msk,
                     RCC_CR_MSIRDY_Pos, &rdy);
    } while (!rdy);
    whal_Reg_Update(clkDev->base, RCC_CR_REG, RCC_CR_MSIRANGE_Msk,
                                     ...
                                     const whal_Stm32wb_Rcc_PllCfg *cfg)
{
    ...
    whal_Reg_Update(clkDev->base, RCC_PLLCFGR_REG, RCC_PLLCFGR_Msk,
