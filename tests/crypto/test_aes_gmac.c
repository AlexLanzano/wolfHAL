...
static void Test_AesGmac_Basic(void)
{
    uint8_t tag1[16] = {0};
    uint8_t tag2[16] = {0};
...
static void Test_AesGmac_KnownAnswer(void)
{
    uint8_t tag[16] = {0};
...
{
    WHAL_TEST_SUITE_START("aes_gmac");
    WHAL_TEST(Test_AesGmac_Basic);
    WHAL_TEST(Test_AesGmac_KnownAnswer);
    WHAL_TEST_SUITE_END();
}
